...
int main()
{
   ...
   array<int, TurtleGraphics::ARRAY_SIZE> comds = {5,5,4,5,9,2,    // go to start of first letter and put pen down
   ...
   turtleOne.processTurtleMoves(comds); // have turtle process commands
